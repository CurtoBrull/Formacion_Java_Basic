...
public class EjemploUsoCuenta {
	...
	public static void main(String[] args) {
		...
		Cuenta cuenta2 = new Cuenta("Rosarito", "12345678901234567890", 1.75, 102);
		...
		System.out.println("\n Realizamos ingreso de 2.500� (a cuenta 1)");
		cuenta1.ingreso(2500);
		...
		System.out.println("\n Realizamos transferencia de 100� (de cuenta 3 a 2)");
